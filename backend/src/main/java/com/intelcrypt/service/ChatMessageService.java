...
public class ChatMessageService {
    ...
    public MessageDTO.ChatMessageResponse sendMessage(
        ...
        message.setEncryptedContent(request.getContentEncrypted() != null ? request.getContentEncrypted() : request.getContent());
        ...
        return convertToResponse(savedMessage, chatId);
    }
    ...
    public List<MessageDTO.ChatMessageResponse> searchMessages(UUID chatId, UUID userId, String query) {
        ...
        // In a real implementation, you'd search through metadata or have a search index
